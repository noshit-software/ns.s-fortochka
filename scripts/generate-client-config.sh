...
echo "$VLESS_LINK"
echo ""
log_info "Send this link or QR code to the phone. In v2RayTun/v2rayNG:"
log_info "  iOS:     Open v2RayTun > + > Import from clipboard (or scan QR)"
log_info "  Android: Open v2rayNG > + > Import config from clipboard (or scan QR)"
